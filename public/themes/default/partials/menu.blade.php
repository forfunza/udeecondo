    ...
    <div class="container">
        ...
        <nav>
            <ul class="menu">
                ...
                <li><a href="#" class="{{ Request::segment(2) == 'project' ? 'active' : ''  }}">{{{ trans('menu.information') }}} <span class="caret"></span></a>
                <ul class="sub-menu">
            ...
            <li><a href="#" class="{{ Request::segment(2) == 'plan' ? 'active' : ''  }}">{{{ trans('menu.plan') }}} <span class="caret"></span></a>
            <ul class="sub-menu">
