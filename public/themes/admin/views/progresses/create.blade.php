{{ Form::open(array('action' => array('ProgressesController@store'), 'method' => 'post', 'class' => 'form-horizontal bucket-form' , 'enctype' => 'multipart/form-data')) }}
	<section class="panel">
				...
				<div class="tab-content">
					...
					<div id="data-{{ $language->id }}" class="tab-pane {{ $language->id == 1 ? 'active' : ''}}">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="progress_description[{{ $language->id }}][name]" value="" type="text" class="form-control" required>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<textarea name="progress_description[{{ $language->id }}][description]"  class="ckeditor form-control" rows="6"></textarea>
							</div>
						</div>
					</div>
					@endforeach
