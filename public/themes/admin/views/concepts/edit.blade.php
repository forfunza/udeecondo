{{ Form::open(array('action' => array('ConceptsController@update', $concept->id), 'method' => 'put', 'class' => 'form-horizontal bucket-form' , 'enctype' => 'multipart/form-data')) }}
	<section class="panel">
		<header class="panel-heading">
			แนวคิด
			<div class="pull-right">
				<!-- <button type="submit" class="btn btn-warning" style="padding-left:25px; padding-right:25px;">กลับ</button> -->
				<button type="submit" class="btn btn-primary" style="padding-left:25px; padding-right:25px;">แก้ไข</button>
			</div>
		...
		<div class="panel-body">
			<div class="form-group">
					...
					<div class="col-md-10">
						<div class="fileupload fileupload-{{ !empty($concept->image) ? 'exists' : 'new'}}" data-provides="fileupload">
							...
							<div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 400px; max-height: 350px; line-height: 20px;">
								@if(!empty($concept))
								<img src='{{ !empty($concept->image) ? $concept->image : "" }}'>
								@endif
							</div>
							<div>
