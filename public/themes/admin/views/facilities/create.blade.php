<form action="{{ action('FacilitiesController@store') }}" enctype="multipart/form-data"  method="post" class="form-horizontal bucket-form ">
	<section class="panel">
				...
				<div class="tab-content">
					...
					<div id="data-{{ $language->id }}" class="tab-pane {{ $language->id == 1 ? 'active' : ''}}">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="facility_description[{{ $language->id }}][name]" value="" type="text" class="form-control" required>
							</div>
