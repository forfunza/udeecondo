{{ Form::open(array('action' => array('GalleriesController@update',$gallery->id), 'method' => 'put', 'class' => 'form-horizontal bucket-form' , 'enctype' => 'multipart/form-data')) }}
	<section class="panel">
		...
		<div class="panel-body">
			<div class="form-group">
					...
					<div class="col-md-10">
						<div class="fileupload fileupload-{{ !empty($gallery->image) ? 'exists' : 'new'}}" data-provides="fileupload">
							...
							<div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 400px; max-height: 350px; line-height: 20px;">
								@if(!empty($gallery))
								<img src='{{ !empty($gallery->image) ? $gallery->image : "" }}'>
								@endif
							</div>
							<div>
